...
4118969 1     161656   07:28:16  bun ~/.claude/plugins/cache/henyeu247-max/claude-mem-xai/9.0.0/scripts/worker-service.cjs --daemon
```
...
- **Issue:** https://github.com/henyeu247-max/claude-mem-xai/issues/603
- **Source Files:**
