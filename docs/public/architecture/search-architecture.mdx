...
**Location:** `/Users/YOUR_USERNAME/.claude/plugins/marketplaces/henyeu247-max/plugin/scripts/mcp-server.cjs`
...
```json
{
  "mcpServers": {
    "mcp-search": {
      "command": "node",
      "args": [
        "/Users/YOUR_USERNAME/.claude/plugins/marketplaces/henyeu247-max/plugin/scripts/mcp-server.cjs"
      ]
    }
  }
}
