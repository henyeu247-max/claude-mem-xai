...
1. Clear install cache:
   ```bash
   rm ~/.claude/plugins/marketplaces/henyeu247-max/.install-version
   ```
...
3. Check version marker:
   ```bash
   cat ~/.claude/plugins/marketplaces/henyeu247-max/.install-version
   cat ~/.claude/plugins/marketplaces/henyeu247-max/package.json | grep version
   ```
...
3. Check package.json exists:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/henyeu247-max/package.json
   ```
...
3. Verify installation:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/henyeu247-max/
   ```
...
2. **Create issue**: [GitHub Issues](https://github.com/henyeu247-max/claude-mem-xai/issues)
