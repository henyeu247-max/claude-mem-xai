...
Copyright (C) 2025 Alex Newman (@henyeu247-max). Minden jog fenntartva.
...
- **Hibák**: [GitHub Issues](https://github.com/henyeu247-max/claude-mem-xai/issues)
- **Tároló**: [github.com/henyeu247-max/claude-mem-xai](https://github.com/henyeu247-max/claude-mem-xai)
- **Szerző**: Alex Newman ([@henyeu247-max](https://github.com/henyeu247-max))
