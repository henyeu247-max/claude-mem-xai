...
Telif Hakkı (C) 2025 Alex Newman (@henyeu247-max). Tüm hakları saklıdır.
...
- **Sorunlar**: [GitHub Issues](https://github.com/henyeu247-max/claude-mem-xai/issues)
- **Depo**: [github.com/henyeu247-max/claude-mem-xai](https://github.com/henyeu247-max/claude-mem-xai)
- **Yazar**: Alex Newman ([@henyeu247-max](https://github.com/henyeu247-max))
