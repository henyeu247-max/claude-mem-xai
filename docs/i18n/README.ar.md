...
حقوق النشر (C) 2025 Alex Newman (@henyeu247-max). جميع الحقوق محفوظة.
...
- **التوثيق**: [docs/](docs/)
- **المشكلات**: [GitHub Issues](https://github.com/henyeu247-max/claude-mem-xai/issues)
- **المستودع**: [github.com/henyeu247-max/claude-mem-xai](https://github.com/henyeu247-max/claude-mem-xai)
- **المؤلف**: Alex Newman ([@henyeu247-max](https://github.com/henyeu247-max))
