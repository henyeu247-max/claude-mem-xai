...
CLAUDE_MEM_REPO="https://github.com/henyeu247-max/claude-mem-xai.git"
...
find_claude_mem_install_dir() {
  ...
  local -a search_paths=(
    ...
    "${HOME}/.claude/plugins/marketplaces/henyeu247-max"
...
start_worker() {
  ...
  if ! find_claude_mem_install_dir; then
    ...
    error "  ~/.claude/plugins/marketplaces/henyeu247-max/plugin/scripts/"
    error ""
