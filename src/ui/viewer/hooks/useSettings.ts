    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        ...
        setSettings({
          ...
          CLAUDE_MEM_XAI_API_KEY: data.CLAUDE_MEM_XAI_API_KEY ?? DEFAULT_SETTINGS.CLAUDE_MEM_XAI_API_KEY,
          CLAUDE_MEM_XAI_MODEL: data.CLAUDE_MEM_XAI_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_XAI_MODEL,
          CLAUDE_MEM_NVIDIA_API_KEY: data.CLAUDE_MEM_NVIDIA_API_KEY ?? DEFAULT_SETTINGS.CLAUDE_MEM_NVIDIA_API_KEY,
          CLAUDE_MEM_NVIDIA_MODEL: data.CLAUDE_MEM_NVIDIA_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_NVIDIA_MODEL,
